...
class ScaleOffloadLog(Document):
	...
	def on_update(self):
		...
		if scale_item_doc.type == "OUT" or scale_item_doc.type == "DIRC" or scale_item_doc.type == "OTH":
			...
			if self.offload_image_upload:
				scale_item_doc.offload_image_upload = self.offload_image_upload.replace("/private","")
