				...
				callback: function (r) {
					...
					if (r.message) {
						...
						if (r.message._Tare > 1000) {
							...
							frappe.web_form.set_value("offload_blank_weight", r.message._Tare);
							frappe.web_form.set_value("offload_gross_weight", r.message._ToughWeight);
							frappe.web_form.set_value("offload_net_weight", r.message._NetWeight);
						}
					}
					else {
