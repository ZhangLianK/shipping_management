    ...
    if user_doc.phone:
        ...
        if drivers:
            for driver in drivers:
                scale_items += frappe.get_all('Scale Item', filters={'driver': driver.name, 'to_dt':''}, fields=['name', 'status', 'date', 'vehicle', 'from_dt', 'to_dt','from_addr', 'to_addr'], order_by='from_dt desc')
